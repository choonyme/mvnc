...
class rfbProto {
  ...
  static String versionMsg;		//mvnc02 support
  ...
  rfbProto(String h, int p, Mvncviewer v) throws IOException {
	viewer = v;
    host = h;
    port = p;
  ...
  void writeVersionMsg() throws IOException {
    ...
    if (serverMajor > 3 || serverMinor >= 8) {
      clientMinor = 8;
      versionMsg = versionMsg_3_8;
      os.write(versionMsg_3_8.getBytes());
    } else if (serverMinor >= 7) {
      clientMinor = 7;
      versionMsg = versionMsg_3_7;
      os.write(versionMsg_3_7.getBytes());
    } else {
      clientMinor = 3;
      versionMsg = versionMsg_3_3;
